...
<div class="breadcrumb-header justify-content-between">
    <div class="left-content">
        <div>
            <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">Citas Reprogramadas</h2>
        </div>
    </div>
    <div class="d-flex my-xl-auto right-content">
        <div class="pr-1 mb-3 mb-xl-0">
            
            <a href="/api/citas/export/reprogramadas" class="btn btn-info"><i class="fas fa-file-excel"></i> Exportar a Excel</a>
        </div>
    </div>
</div>
...
<script>
    ...
    function dibujarCitas(data) {
        ...
        data.forEach(e => {
            ...
            html += '<td>'+e.medico+'</td>';
            html += '<td>'+(e.motivo_reprogramacion == null ? '' : e.motivo_reprogramacion)+'</td>';
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PessDev\Downloads\admin-eldoctor.pe\laravel\resources\views/cita/reprogramada.blade.php ENDPATH**/ ?>