<?php $__env->startSection('title', 'Plantilla Medicamento Especialidad'); ?>
...
<div class="breadcrumb-header justify-content-between">
    <div class="left-content">
        <div>
            <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">Plantilla Medicamento Especialidad</h2>
        </div>
    </div>
...
<script>
    ...
    function obtenerPlantillas() {
        $.ajax({
            type: 'get',
            url: '/api/plantillas/medicamentos-especialidades',
            data: {
    ...
    function toggleModal(id) {
        var url = '/plantillas/medicamentos-especialidades/' + id;
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PessDev\Downloads\admin-eldoctor.pe\laravel\resources\views/plantilla/medicamento-especialidad/index.blade.php ENDPATH**/ ?>